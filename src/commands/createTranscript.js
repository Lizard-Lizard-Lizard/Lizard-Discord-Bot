  ...
  async execute(interaction) {
    try {
      ...
      try {
        ...
        // Ensure UTF-8 with BOM so common viewers (e.g., Windows Notepad) display correctly
        const normalized = transcript.normalize('NFC');
        const utf8Bom = Buffer.from([0xef, 0xbb, 0xbf]);
        const buffer = Buffer.concat([utf8Bom, Buffer.from(normalized, 'utf8')]);
